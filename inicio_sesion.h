    ...
    while (1) {
        ...
        switch (opcion) {
            case 1: {
                ...
                int intentos = 0;
                while (!registrarUsuario(usuario)) {
                    if (++intentos >= MAX_INTENTOS) {
                        printf("Demasiados intentos fallidos para registrarse.\n");
                        
                    }
                    printf("Intentemos registrarte nuevamente...\n");
                }
                ...
                while (!iniciarSesion()) {
                    ...
                    printf("Intentemos iniciar sesión nuevamente...\n");
                }
                break;
            }
            case 2: {
                ...
                while (!iniciarSesion()) {
                    if (++intentos >= MAX_INTENTOS) {
                        printf("Has intentado iniciar sesion demasidas veces. Intentelo mas tarde\n");
